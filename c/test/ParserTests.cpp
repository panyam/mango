...
public:
    ...
    {
        // register filters
        register_in_library(context, filterLibrary, "add", (MangoObject *)mango_addfilter_default());

        // and register the "for" tag
        register_in_library(context, tagLibrary, "for", (MangoObject *)mango_fortagparser_default());
    }
