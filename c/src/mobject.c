...
int mango_object_compare(const MangoObject *obj1, const MangoObject *obj2)
{
    ...
    {
        if (obj1->prototype->compareFunc != NULL)
        {
            return obj1->prototype->compareFunc(obj1, obj2);
        }
        else if (obj2->prototype->compareFunc != NULL)
        {
            return obj2->prototype->compareFunc(obj2, obj1);
        }
        return 0;
    }
...
BOOL mango_object_equal(const MangoObject *obj1, const MangoObject *obj2)
{
    ...
    {
        if (obj1->prototype->equalsFunc != NULL)
        {
            return obj1->prototype->equalsFunc(obj1, obj2);
        }
        else if (obj2->prototype->equalsFunc != NULL)
        {
            return obj2->prototype->equalsFunc(obj2, obj1);
        }
        return true;
    }
    return false;
